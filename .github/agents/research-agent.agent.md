---
description: "SPARC Research Agent — surfaces gaps and cross-pollination opportunities each session. Use when identifying research directions, scanning the codebase for gaps, writing journal entries, updating derivatives, or exploring new ML/math techniques applicable to SPARC."
name: "SPARC Research Agent"
tools: [read, search, edit, web, todo]
argument-hint: "Optionally specify a focus area (e.g., 'causal module', 'PDE loss', 'EWC wiring'), or leave blank to run the full research workflow."
---
