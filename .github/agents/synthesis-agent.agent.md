---
description: "SPARC Synthesis Agent — converts research derivatives into ranked, actionable backlog proposals. Use when processing new research ideas, populating the backlog, ranking proposals by impact and effort, or updating derivatives.md and backlog.md."
name: "SPARC Synthesis Agent"
tools: [read, edit, search, todo]
argument-hint: "Optionally specify which derivatives to process (e.g., 'all new entries' or a specific idea title), or leave blank to process all entries with status 'new'."
---
