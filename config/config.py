...
SPARC_CORE_DIR = os.path.dirname(CONFIG_DIR)
PROJECT_ROOT = os.path.dirname(SPARC_CORE_DIR)
OUTPUT_DIR = os.path.join(SPARC_CORE_DIR, "output")
RAW_CSV_PATH = os.path.join(SPARC_CORE_DIR, "data", "brown4.csv")
